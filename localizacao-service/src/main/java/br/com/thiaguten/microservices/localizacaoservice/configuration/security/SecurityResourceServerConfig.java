package br.com.thiaguten.microservices.localizacaoservice.configuration.security;

import static br.com.thiaguten.microservices.localizacaoservice.support.security.RolesAllowedConstants.REALM_ROLE_SGO_USER;
import static br.com.thiaguten.microservices.localizacaoservice.support.security.RolesAllowedConstants.CLIENT_ROLE_ENDERECOS_READ;
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests(authorize -> authorize
                ...
                //.mvcMatchers("/api/v1/enderecos/**").hasRole(REALM_ROLE_SGO_USER)

                // Restrição mais granular através de roles focadas mais no resource_access.
                .mvcMatchers(HttpMethod.GET, "/api/v1/enderecos/**")
                   .hasAnyRole(REALM_ROLE_SGO_USER, CLIENT_ROLE_ENDERECOS_READ)
